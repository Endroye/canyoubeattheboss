...
leaderboard = {}          # Current session leaderboard (reset on boss defeat)
global_leaderboard = {}   # Overall damage statistics (never reset)
boss_base_hp = 200
...
# --- Overlay Update Function (with Overall Damage Statistic) ---
...
async def auto_upload_github():
    repo_path = "/home/Endroye/canyoubeattheboss"  # Adjust this path!
    try:
        repo = Repo(repo_path)
